  ...
  const achievements = [
    {
      title: "Líder en Lima",
      description:
        "ZIMA es una marca de bienes raíces reconocida en Lima, Perú",
    },
    {
      title: "Tecnología Avanzada",
      description:
        "Utilizamos las herramientas más modernas para la comercialización de propiedades",
    },
    {
      title: "Red Global",
      description: "Conectamos compradores y vendedores en más de 110 países",
    },
    {
      title: "Agentes Certificados",
      description:
        "Nuestros agentes están altamente capacitados y certificados",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            ...
            global que nos permite ofrecer el mejor servicio a nuestros
            clientes.
          </p>
        </div>
              ...
              {activeTab === "about" && (
                <div>
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    ZIMA es una empresa de bienes raíces especializada en el
                    mercado de Lima, Perú. Contamos con agentes profesionales y
                    las herramientas más avanzadas para ayudarte a encontrar la
                    propiedad perfecta.
                  </p>
                  <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              {activeTab === "mission" && (
                <div>
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    ...
                    transparente y de alta calidad. Conectamos sueños con
                    realidades inmobiliarias.
                  </p>
                  <div className="space-y-4">
                    <div className="flex items-start">
                      <Shield className="w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" />
                      <p className="text-gray-600">
                        Garantizar transparencia en cada transacción
                      </p>
                    </div>
                    <div className="flex items-start">
                      <TrendingUp className="w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" />
                      <p className="text-gray-600">
                        Maximizar el valor de las inversiones inmobiliarias
                      </p>
                    </div>
                    <div className="flex items-start">
                      <Users className="w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" />
                      <p className="text-gray-600">
                        Brindar asesoría personalizada y profesional
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-primary to-secondary rounded-2xl p-8 text-white">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold mb-4">ZIMA Real Estate</h3>
                  <p className="mb-6 opacity-90">
                    Tu socio de confianza en bienes raíces
                  </p>
                  <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                    <p className="text-sm opacity-90">
                      "Compra • Venta • Inversión en Lima, Perú"
                    </p>
                  </div>
                </div>
              </div>
